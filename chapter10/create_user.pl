...
# --fname Foo --lname Bar
# /usr/sbin/adduser --home /opt/bfoo --disabled-password --gecos "Foo Bar" bfoo

my $useradd = '/usr/bin/useradd';
...
my $cmd = qq($useradd --home $home --disabled-password --gecos "$opts{fname} $opts{lname}");
